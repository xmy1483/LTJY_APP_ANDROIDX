...
public class OilRechargeResultActivity extends AutomaticBaseActivity {

    public static Intent newIntent(Context context) {
        return new Intent(context, OilRechargeResultActivity.class);
    }

    @Override
    protected void initView() {
        setContentView(R.layout.oil_recharge_result_activity);
        ...
        money.setText(String.format(getString(R.string.oil_recharge_result), intent.getStringExtra("recharge_money")));
        cardNo.setText(intent.getStringExtra("card_no"));
    ...
    public void onBackPressed() {
        UIUtils.startActivityInAnim(activity, MainActivity.newIntent(activity));
        OilRechargeResultActivity.this.finish();
    }
