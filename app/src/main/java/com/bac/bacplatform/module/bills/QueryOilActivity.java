...
public class QueryOilActivity extends AutomaticBaseActivity implements BaseQuickAdapter.RequestLoadMoreListener {
    ...
    private QueryOilAdapter adapter;
    ...
    protected void initView() {
        ...
        adapter = new QueryOilAdapter(R.layout.oil_item_context);
    ...
    private void CARD_XML_QUERY_OIL_ORDER(final boolean b) {
        HttpHelper.getInstance().bacNetWithContext(this, new BacHttpBean()
                .setMethodName("CARD_XML.QUERY_OIL_ORDER")
                ...
                .compose(new Observable.Transformer<String, String>() {
                    ...
                    public Observable<String> call(Observable<String> stringObservable) {
                        ...
                        if (b) {
                            return stringObservable.compose(new RxDialog<String>().rxDialog(QueryOilActivity.this));
                        } else {
