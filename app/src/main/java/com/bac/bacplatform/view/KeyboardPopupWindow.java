...
import static com.bac.bacplatform.conf.Constants.CommonProperty._5;
import static com.bac.bacplatform.conf.Constants.CommonProperty._6;
...
public class KeyboardPopupWindow {
    ...
    public KeyboardPopupWindow(List<String> list, final Context activity, View view, final KeyboardCallback keyboardCallback, final View.OnClickListener clickListener) {
        ...
        rv = (RecyclerView) popup.findViewById(R.id.rv);
...
//                }
    ...
    public void setLoading(AutomaticBaseActivity activity) {
    ...
    public void setFail(AutomaticBaseActivity activity, Util._3CountDownCallback callback) {
        int width = rv.getWidth();
        int height = rv.getHeight();
        // 增加成功切换界面
        ...
        tv = (TextView) fail.findViewById(R.id.tv);
    ...
    public void setShowCountDown(AutomaticBaseActivity activity, Util._3CountDownCallback callback) {
        ...
        tv = (TextView) success.findViewById(R.id.tv);
        tv.setText(String.format(activity.getString(R.string.kaiyoubao_pwd_dialog), "3"));
        kaiYouBaoRechargeAdapter.setNewData(null);
