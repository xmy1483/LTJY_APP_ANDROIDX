...
import static com.bac.bacplatform.R.id.ll;
...
public class InsuranceUploadAddress extends SuperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etDialog01 = (CanClearEditText) findViewById(R.id.et_dialog_01);
        etDialog02 = (CanClearEditText) findViewById(R.id.et_dialog_02);
        tv = (TextView) findViewById(R.id.tv);
        etDialog03 = (CanClearEditText) findViewById(R.id.et_dialog_03);
        mLl = (LinearLayout) findViewById(ll);
        ...
        mBtnRv = (Button) mLatestLayout.findViewById(R.id.btn);
        mBtnRv.setText("确认");
        mLatestRv = (RecyclerView) mLatestLayout.findViewById(R.id.rv);
    ...
    private void initEvent() {
        ...
        tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.hideSoftInputFromWindow(tv.getWindowToken(), 0); //强制隐藏键盘
                addressPopupView.showPopup(findViewById(ll), Gravity.BOTTOM, 0, 0);
    ...
    private void goToHome() {
        Intent intent = new Intent(InsuranceUploadAddress.this,
                MainActivity.class);
