...
import com.bac.bacplatform.old.module.insurance.adapter.VideoAdapter;
...
import static com.bac.bacplatform.utils.ui.UIUtils.callbackBitmap_3;
...
public class InsuranceQueryVideo extends SuperActivity {
    ...
    private void initView2() {
        ...
        rvInsuranceVideo = (RecyclerView) findViewById(R.id.rv_insurance_video);

        mBtn = (Button) findViewById(R.id.btn_insurance);
    }
    ...
    private void doNetAuditinginsure() {
        ...
        if (getIntent().getIntExtra("status", 0) != 14) {
            UIUtils.startActivityInAnim(activity,new Intent(InsuranceQueryVideo.this, InsuranceUploadAddress.class).putExtra("bean", mBean));
        } else {
            doNet();
        }
    ...
    private void doNetUploadImage(final Map<String, Object> mHashMap, FrameLayout parent) {
        ...
        hashMap.put("login_phone", Long.parseLong(BacApplication.getLoginPhone()));
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    ...
                    final Request request = new Request.Builder()
                            ...
                            .post(body)
                            .build();
                    Response execute = BacApplication.getOkHttpClient().newCall(request)
                            .execute();
