...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/26e3295ad9d3a15a6cd486aea0b3df0e', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/26e3295ad9d3a15a6cd486aea0b3df0e',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.adv_title}
	                      }
	                    }
	                  ]
	                },
	                {
	                  "type": "div",
	                  "repeat": {
	                    "expression": function () {return this.taskList},
	                    "value": "item"
	                  },
	                  "classList": [
	                    "div_pro"
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "style": {
	                            "color": function () {return this.judge(this.item)?'#B2B2B2':'black'}
	                          },
	                          "attr": {
	                            "value": function () {return this.dealTime(this.item)}
	                          }
	                        },
	                        {
	                          "type": "text",
	                          ...
	                          "attr": {
	                            "value": function () {return this.getTaskType(this.item)}
	                          }
	                        }
	                      ]
	                    },
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "classList": function () {return ['line', 'lineone', this.dealTime(this.item)?'linecolor':'']}
	                        },
	                        {
	                          "type": "div",
	                          "shown": function () {return this.$index!=0},
	                          "classList": function () {return ['line', 'linetwo', this.dealTime(this.item)?'linecolor':'']}
	                        },
	                        {
	                          "type": "div",
	                          "classList": function () {return ['circle', this.dealTime(this.item)?'':'circleone']}
	                        }
	                      ]
	                    },
	                    {
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.dealDescribe(this.item)}
	                          }
	                        }
	                      ]
	                    }
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "circle": {
	    ...
	    "height": "30wx",
	    "borderTopWidth": "5wx",
	    "borderBottomWidth": "5wx",
	    "borderLeftWidth": "5wx",
	    "borderRightWidth": "5wx",
	    "borderTopColor": "#41C0AD",
	    "borderBottomColor": "#41C0AD",
	    "borderLeftColor": "#41C0AD",
	    "borderRightColor": "#41C0AD",
	    "borderRadius": 100
	  },
	  "circleone": {
	    "width": "30wx",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        dealTime: function dealTime(item) {
	            var time;
	            switch (item.status) {
	                case 0:
	        ...
	        judge: function judge(item) {
	            if (item.status == 20 || item.status == 30 || item.status == 100 || item.status == 300 || item.status == 400 || item.status == 500 || item.status == 600) {
	                return true;
	            } else {
	                return false;
	            }
	        },
	        dealDescribe: function dealDescribe(item) {
	            var award_voucher = item.award_voucher ? item.award_voucher : '';
	            var award_goods = item.award_goods ? '\n' + item.award_goods : '';
	            var award_money = item.award_money_remark ? '\n' + item.award_money_remark : '';
	            var str = award_voucher + award_goods + award_money;
	            return str;
	        },
	        getTaskType: function getTaskType(item) {
	            var str;
	            switch (item.status) {
	                case 0:
	                    str = '任务未开始';
	        ...
	        getPrecessData: function getPrecessData() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            var listMap;
	            if (self.join_id !== "null") {

	                listMap = [{
	                    "login_phone": self.userInfo.currentPhone,
	                    "join_id": self.join_id
	                }];
	                modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MY_ACTIVITIE",
	                    "actionType": 0,
	                    "listMap": listMap
	                }, function (ret) {
	                    self.taskList = ret.data.listMap;
	                    if (ret.data.listMap.length > 0) {
	                        self.adv_title = ret.data.listMap[0].adv_title;
	                        self.total_award_money = ret.data.listMap[0].total_award_money;
	                        self.total_km = ret.data.listMap[0].total_km;
	                        self.travel_total_km = ret.data.listMap[0].travel_total_km;
	                    }
	                });
	            } else {
	                listMap = [{
	                ...
	                modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MY_CUR_ACTIVITIE",
	                    "actionType": 0,
	                    "listMap": listMap
	                }, function (ret) {
	                    self.taskList = ret.data.listMap;
	    ...
	    created: function created() {
	        ...
	        self.join_id = decodeURIComponent(this._getUrlParam(url, 'join_id'));
