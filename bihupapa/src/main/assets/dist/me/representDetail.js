...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/4c6e072d0d4d3349c2ebdadaf0b7cb56', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/4c6e072d0d4d3349c2ebdadaf0b7cb56',undefined,undefined)
	      ...
	      "children": [
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.current.length>0},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                ...
	                },
	                {
	                  "type": "div",
	                  "repeat": {
	                    "expression": function () {return this.current},
	                    "value": "item"
	                  },
	                  "classList": [
	                    "oDiv"
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.adv_title}
	                          }
	                        }
	                      ]
	                    },
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "children": [
	                            ...
	                            },
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.item.end_time?this.toTime(this.item.end_time):0}
	                              }
	                            }
	                          ]
	                        },
	                        {
	                          ...
	                          "children": [
	                            ...
	                            },
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.item.task_km?this.item.task_km:0}
	                              }
	                            }
	                          ]
	                        },
	                        {
	                          ...
	                          "children": [
	                            ...
	                            },
	                            {
	                              ...
	                              "attr": {
	                                "value": function () {return this.item.award_money?this.item.award_money:0}
	                              }
	                            }
	                          ]
	                        }
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.history.length>0},
	          "children": [
	            {
	              "type": "div",
	              "classList": [
	              ...
	              "children": [
	                ...
	                },
	                {
	                  "type": "div",
	                  "repeat": {
	                    "expression": function () {return this.history},
	                    "value": "item"
	                  },
	                  "events": {
	                    "click": function ($event) {this.representDetailhistoryProcess(this.$index,$event)}
	                  },
	                  "classList": [
	                    "oDiv"
	                  ],
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getDataList: function getDataList() {
	            ...
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MY_ACTIVITIES",
	                "actionType": 0,
	                "listMap": [{
	                    "login_phone": self.userInfo.currentPhone
	                }]
	            }, function (ret) {
	                if (ret.data.mapData.my_activities.length > 0) {
	                    for (var i = 0; i < ret.data.mapData.my_activities.length; i++) {
	                        if (ret.data.mapData.my_activities[i].status < 80) {
	                            self.current.push(ret.data.mapData.my_activities[i]);
	                        } else {
	                            self.history.push(ret.data.mapData.my_activities[i]);
	                        }
	                    }
	                }
	            });
	        ...
	        representDetailcurrentProcess: function representDetailcurrentProcess(e) {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'me/representDetailProcess.js?join_id=' + vm.current[e].join_id,
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        representDetailhistoryProcess: function representDetailhistoryProcess(e) {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'me/representDetailProcess.js?join_id=' + vm.history[e].join_id,
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        }
