...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/a69e7e1b83316b160d45d964f8c401c8', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/a69e7e1b83316b160d45d964f8c401c8',undefined,undefined)
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": "https://app5.bac365.com:10443/web_image/me/idcard@2x.png"
	                  },
	                  "classList": [
	                    "user_icon"
	                  ]
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.userInfo.currentPhone}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "repeat": function () {return this.imageArray1},
	                  "classList": [
	                    "button_icon"
	                  ],
	                  "attr": {
	                    "src": function () {return this.name}
	                  },
	                  "events": {
	                    "click": function ($event) {this.clicklineOne(this.$index,$event)}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "repeat": function () {return this.imageArray2},
	                  "classList": [
	                    "button_icon"
	                  ],
	                  "attr": {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.clicklineTwo(this.$index,$event)}
	                  }
	                }
	              ]
	            }
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "repeat": function () {return this.imageArray3},
	                  "classList": [
	                    "button_icon"
	                  ],
	                  "attr": {
	                  ...
	                  "events": {
	                    "click": function ($event) {this.clicklineThree(this.$index,$event)}
	                  }
	                }
	              ]
	            }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    data: function () {return {
	        ...
	        userInfo: {},
	        imageArray1: [{
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom01@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom02@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom03@3x.png'
	        }],
	        imageArray2: [{
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom04@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom05@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom06@3x.png'
	        }],
	        imageArray3: [{
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom07@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom08@3x.png'
	        }, {
	            'name': 'https://app5.bac365.com:10443/web_image/me/buttom/buttom09@3x.png'
	        }]
	    ...
	    methods: {
	        ...
	        clicklineOne: function clicklineOne(e) {
	            var vm = this;
	            var url = '';
	            switch (e) {
	                case 0:
	                    url = apis.js(vm.baseURL, 'me/representDetail.js');
	                    break;
	                case 1:
	                    url = vm.baseURL + 'message/message.js?from=me';
	                    break;
	                case 2:
	                    url = vm.baseURL + "wallet/walletEntry.js?from=me";
	                    break;
	                default:
	        ...
	        searchAddress: function searchAddress() {
	            var vm = this;
	            var params = {
	                'url': vm.baseURL + 'address/addressList.js?from=me',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        clicklineTwo: function clicklineTwo(e) {
	            var vm = this;
	            var url = '';
	            switch (e) {
	                case 0:
	        ...
	        toPhoto: function toPhoto() {
	            ...
	            modal.toTakePhotoView({ "type": "emergency" }, function (ret) {
	                self.UUID = JSON.parse(ret.data).UUID;
	            });
	        },
	        searchCar: function searchCar() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_CAR_INFO",
	                "actionType": 0,
	                "listMap": [{
	                ...
	                if (ret.data.listMap.length == 0) {
	                    storage.removeItem('carInfo', function (e) {});
	                    self.confirm('前去填写车辆信息');
	                } else {
	                    self.carInfo = ret.data.listMap[0];
	                    storage.setItem('carInfo', (0, _stringify2.default)(ret.data.listMap[0]), function (e) {
	                        var params = {
	                            'url': self.baseURL + 'myCar/myCar.js?from=me',
	                            'animated': 'true'
	                        };
	        ...
	        updateQRInfo: function updateQRInfo(str1, str2) {
	            ...
	            modal.httpServer({ "methodName": "SCAN_CODE",
	                ...
	                if (ret.data.listMap.length > 0) {
	                    ...
	                    self.toast(d.status);
	                    if (d.status == 10 || d.status == 30) {
	                        var modal = __weex_require__('@weex-module/QRcodeModule');
	                        modal.openCarAds({}, function (ret) {});
	                    } else if (d.status >= 100) {

	                        var params = {
	                            'url': self.baseURL + 'main/myRepresent.js',
	                            'animated': 'true'
	                        };
	                        self.$call('navigator', 'push', params, function () {});
	                    }
	        ...
	        clicklineThree: function clicklineThree(e) {
	            var vm = this;
	            var url = '';
	        ...
	        clicklineFour: function clicklineFour(e) {
	            var vm = this;
	            var url = '';
	        ...
	        callPhone: function callPhone() {
	            ...
	            modal.callNative({ "nativeName": "callPhone" }, function (ret) {});
	        },
	        commonQuestion: function commonQuestion() {
	            var self = this;

	            var modal = __weex_require__('@weex-module/httpModule');

	            modal.toWebView('https://mp.weixin.qq.com/s?__biz=MzA3ODk0MzI3Nw==&mid=503202718&idx=1&sn=9876bafd4d625fdd22258b22d994f22d&scene=1&srcid=0415ELtxbOG3xImOp94GnEFS&key=77421cf58af4a65384280b494046c87b347cd42108060a4fe9a8098472e923bea2800762d7e5b36c3742c12640425317&ascene=0&uin=NTIyODQ0MzQw&devicetype=iMac+MacBookPro9%2C1+OSX+OSX+10.9.5+build(13F1112)&version=11020201&pass_ticket=G1mApd9%2BxRWXXUSsmpvSI5Z9%2Be1XwuCHYdVzYxzXOMoLokjnUpI64XMenkFOiwqH');
	        }
	    },
	    ready: function ready() {
	        this.baseConfig();
