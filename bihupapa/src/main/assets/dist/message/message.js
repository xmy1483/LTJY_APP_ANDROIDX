...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/1d585693e6a6c5e7d4b3278d9941a658', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/1d585693e6a6c5e7d4b3278d9941a658',undefined,undefined)
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "attr": {
	    ...
	    "title": function () {return this.title},
	    "titleColor": "#ffffff",
	    "leftItemSrc": function () {return this.from==='me'?'https://app5.bac365.com:10443/web_image/ic_arrow_nor@2x.png':''}
	  },
	  "children": [
	    {
	      "type": "list",
	      ...
	      "children": [
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                {
	                  "type": "text",
	                  "shown": function () {return (this.refresh_display==='show')},
	                  "style": {
	                    "textAlign": "center"
	                  },
	                  "attr": {
	        ...
	        },
	        {
	          ...
	          "events": {
	            "click": function ($event) {this.cellAction(this.$index,$event)}
	          },
	          "children": [
	            {
	              "type": "div",
	              "shown": function () {return this.item.image_url},
	              "classList": [
	                "activity"
	              ],
	              "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.toTime(this.item.create_time)}
	                      },
	                      "children": [
	                        {
	                          "type": "text"
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.info_title}
	                          }
	                        }
	                      ]
	                    },
	                ...
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.item.brief_content}
	                      }
	                    }
	                  ]
	                }
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getMessageList: function getMessageList() {
	            ...
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MY_MESSAGES",
	                "actionType": 0,
	                "listMap": [{
	        ...
	        cellAction: function cellAction(i) {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.UPADATE_MY_MESSAGES",
	                "actionType": 0,
	                "listMap": [{
	                    "login_phone": self.userInfo.currentPhone,
	                    "info_id": self.dataArr[i].info_id
	                }]
	            }, function (ret) {});

	            if (self.dataArr[i].info_url) {
	                modal.toWebView(self.dataArr[i].info_url);
	            }
	        }
	    },
	    ready: function ready() {
