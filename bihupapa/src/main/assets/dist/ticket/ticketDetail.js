...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/586d8067bad6cf6751204f271b369379', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/586d8067bad6cf6751204f271b369379',undefined,undefined)
	          ...
	          "children": [
	            {
	              ...
	              "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.ticketDetail.award_name}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.judgeGetType(this.ticketDetail.status)}
	                      }
	                    }
	                  ]
	                },
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "src": function () {return this.ticketDetail.award_image?this.ticketDetail.award_image:'https://app5.bac365.com:10443/web_image/representDetail/activityDetail.jpg'},
	                        "resize": "contain"
	                      }
	                    }
	                  ]
	                ...
	                {
	                  "type": "div",
	                  "shown": function () {return this.award_type==10},
	                  "children": [
	                    {
	                      "type": "div",
	                      "repeat": function () {return this.dataEleArr},
	                      "classList": [
	                        "oDiv",
	                        "oDiv1"
	                      ],
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "src": function () {return this.ticketDetail.award_remark_img?this.ticketDetail.award_remark_img:'https://app5.bac365.com:10443/web_image/representDetail/activityDetail.jpg'},
	                            "resize": "contain"
	                          }
	                        }
	                      ]
	                ...
	                {
	                  "type": "div",
	                  "shown": function () {return this.award_type==20},
	                  "children": [
	                    {
	                      "type": "div",
	                      "repeat": function () {return this.dataArr},
	                      "children": [
	                        {
	                          "type": "div",
	                          "shown": function () {return this.ticketDetail.status==20},
	                          "children": [
	                            {
	                              "type": "div",
	                              "classList": [
	                              ...
	                              "shown": function () {return this.$index!=2&&this.$index!=3},
	                              "children": [
	                                {
	                                  "type": "text",
	                                  "classList": [
	                        ...
	                        {
	                          "type": "div",
	                          "shown": function () {return this.ticketDetail.status==10},
	                          "children": [
	                            {
	                              "type": "div",
	                              "classList": [
	                              ...
	                              "shown": function () {return this.$index!=4},
	                              "children": [
	                                {
	                                  "type": "text",
	                                  "classList": [
	                    ...
	                    {
	                      "type": "div",
	                      "repeat": function () {return this.dataArr1},
	                      "children": [
	                        {
	                          "type": "div",
	                          "shown": function () {return this.ticketDetail.status!=20&&this.ticketDetail.status!=10},
	                          "children": [
	                            {
	                              "type": "div",
	                              "classList": [
	            ...
	            {
	              "type": "div",
	              "shown": function () {return this.award_type==20&&this.ticketDetail.status==20},
	              "classList": [
	                "bg"
	              ],
	              "style": {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        ...
	                        "placeholder": "收件人姓名",
	                        "autofocus": "false",
	                        "value": function () {return this.lastAddrss.recipient_name}
	                      },
	                      "events": {
	                        "input": "onchangeName"
	                      }
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        ...
	                        "placeholder": "用户手机号",
	                        "autofocus": "false",
	                        "value": function () {return this.lastAddrss.recipient_phone}
	                      },
	                      "events": {
	                        "input": "onchangePhone"
	                      }
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            ...
	                            "value": function () {return this.lastAddrss.address}
	                          },
	                          "events": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        judgeGetType: function judgeGetType(e) {
	            var msg = '';
	            switch (e) {
	                case 0:
	                    msg = '未发放';
	        ...
	        onchangeName: function onchangeName(e) {
	            this.lastAddrss.recipient_name = e.value;
	        },
	        onchangePhone: function onchangePhone(e) {
	            this.lastAddrss.recipient_phone = e.value;
	        },
	        onchangeAddress: function onchangeAddress(e) {
	            this.lastAddrss.address = e.value;
	        },
	        sureBtn: function sureBtn() {
	            var self = this;
	            if (!self.lastAddrss.recipient_name || self.lastAddrss.recipient_name == '') {
	                self.toast('请填写收件人姓名');
	                return;
	            }
	            if (!self.lastAddrss.recipient_phone || self.lastAddrss.recipient_phone == '') {
	                self.toast('请填写收件人手机号');
	                return;
	            }
	            if (!self.lastAddrss.address || self.lastAddrss.address == '') {
	                self.toast('请填写收件人地址');
	                return;
	            }
	            var modal = __weex_require__('@weex-module/httpModule');
	            if (self.lastAddrss.address_id) {
	                modal.httpServer({ "methodName": "ADD_AWARD_ADDRESS",
	                    "actionType": 0,
	                    "listMap": [{ "address_id": self.lastAddrss.address_id,
	                        "customers_id": self.userInfo.customers_id,
	                        "login_phone": self.userInfo.currentPhone,
	                        "award_record_id": self.award_record_id,
	                        "recipient_name": self.lastAddrss.recipient_name,
	                        "recipient_phone": self.lastAddrss.recipient_phone,
	                        "address": self.lastAddrss.address }]
	                }, function (ret) {
	                ...
	                modal.httpServer({ "methodName": "ACTIVITIE.ADD_MAILING_ADDRESS",
	                    "actionType": 0,
	                    "listMap": [{
	                        "customers_id": self.userInfo.customers_id,
	                        "login_phone": self.userInfo.currentPhone,
	        ...
	        getdetail: function getdetail() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_REAL_REWARD",
	                "actionType": 0,
	                "listMap": [{
	                    "login_phone": self.userInfo.currentPhone,
	                    "award_record_id": self.award_record_id
	                ...
	                self.ticketDetail = ret.data.listMap[0];
	                if (self.award_type == 10) {

	                    self.dataEleArr[0].detail = self.ticketDetail.award_remark;
	                    self.dataEleArr[1].detail = self.ticketDetail.award_money;
	                    self.dataEleArr[2].detail = self.toTime(self.ticketDetail.expired);
	                }
	                if (self.award_type == 20) {
	                    if (self.ticketDetail.status == 10 || self.ticketDetail.status == 20) {
	                        self.dataArr[0].detail = self.ticketDetail.award_remark;
	                        self.dataArr[1].detail = self.ticketDetail.award_money;
	                        self.dataArr[2].detail = self.ticketDetail.send_phone ? self.ticketDetail.send_phone : '';
	                        self.dataArr[3].detail = self.ticketDetail.get_address ? self.ticketDetail.get_address : '';
	                        if (self.ticketDetail.get_way == 0) {
	                            self.dataArr[4].detail = "自提";
	                        }
	                        if (self.ticketDetail.get_way == 10) {
	                            self.dataArr[4].detail = "快递到付";
	                        }
	                        if (self.ticketDetail.get_way == 20) {
	                            self.dataArr[4].detail = "免费邮寄";
	                        }

	                        if (self.ticketDetail.status == 20) {
	                            self.getHistoryAddress();
	                        }
	                    }
	                    if (self.ticketDetail.status != 10 && self.ticketDetail.status != 20) {

	                        self.dataArr1[0].detail = self.ticketDetail.award_remark ? self.ticketDetail.award_remark : '';
	                        self.dataArr1[1].detail = self.ticketDetail.award_money ? self.ticketDetail.award_money : '';
	                        if (self.ticketDetail.get_way == 0) {
	                            self.dataArr1[2].detail = "自提";
	                        }
	                        if (self.ticketDetail.get_way == 10) {
	                            self.dataArr1[2].detail = "快递到付";
	                        }
	                        if (self.ticketDetail.get_way == 20) {
	                            self.dataArr1[2].detail = "免费邮寄";
	                        }

	                        self.dataArr1[3].detail = self.ticketDetail.recipient_name ? self.ticketDetail.recipient_name : '';
	                        self.dataArr1[4].detail = self.ticketDetail.send_phone ? self.ticketDetail.send_phone : '';
	                        self.dataArr1[5].detail = self.ticketDetail.get_address ? self.ticketDetail.get_address : '';
	                    }
	                }
	            });
	        },
	        getHistoryAddress: function getHistoryAddress() {
	            var self = this;
	            var listMap = [];
	            ...
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MAILING_ADDRESS",
	                "actionType": 0,
	                "listMap": listMap
	            }, function (ret) {
	                if (ret.data.listMap.length > 0) {
	                    self.lastAddrss = ret.data.listMap[0];
	                }
	            });
	        }
	    },
	    ...
	    created: function created() {
	        ...
	        storage.getItem('userInfo', function (e) {
	            ...
	            if (result === 'success') {
	                var data = e.data;
	                self.userInfo = JSON.parse(JSON.parse(data));
	                self.getTicketArr();
	            } else {}
	        });
	        var config = self.$getConfig();
	        var url = config.bundleUrl;
	        self.award_record_id = decodeURIComponent(this._getUrlParam(url, 'award_record_id'));
	        self.award_type = decodeURIComponent(this._getUrlParam(url, 'award_type'));
	        this.getdetail();
	        this.baseURL = apis.getBaseUrl(this.$getConfig().bundleUrl);
	        this.imageURL = apis.imageUrl;
