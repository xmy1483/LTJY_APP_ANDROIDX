...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/ae01e7301fff5b18cf4b126e6e7feb3b', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/ae01e7301fff5b18cf4b126e6e7feb3b',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.dataArr},
	            "value": "item"
	          },
	          "events": {
	            "click": function ($event) {this.toTicketDetail(this.$index,$event)}
	          },
	          "children": [
	            {
	              "type": "div",
	              ...
	              "children": [
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.award_remark}
	                          }
	                        }
	                      ]
	                    },
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.award_name}
	                          }
	                        }
	                      ]
	                    },
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return '价值现金：￥' + (this.item.award_money)}
	                          }
	                        }
	                      ]
	                    }
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "children": [
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==1},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/unget.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                        ...
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==30},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/38.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                        ...
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==38},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/38.png'}
	                          },
	                          "style": {
	                        ...
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==40},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/40.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                    ...
	                    },
	                    {
	                      ...
	                      "children": [
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==20},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/unpost.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                        ...
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==10},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/unuserget.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                        ...
	                        },
	                        {
	                          ...
	                          "shown": function () {return this.item.status==30},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/30.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                        ...
	                        {
	                          "type": "image",
	                          "shown": function () {return this.item.status==31},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'wallet/31.png'}
	                          },
	                          "style": {
	                            "height": "100wx",
	                            "width": "100wx"
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "src": function () {return (this.imageURL) + 'award/rewardmask@3x.png'}
	                  }
	                },
	                {
	                  "type": "image",
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.dataArr.length==0},
	          "children": [
	            {
	              "type": "div",
	              "style": {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        toTicketDetail: function toTicketDetail(e) {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'ticket/ticketDetail.js?award_record_id=' + vm.dataArr[e].award_record_id + '&award_type=' + vm.award_type,
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        getTicketArr: function getTicketArr() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_REAL_REWARDS",
	                "actionType": 0,
	                "listMap": [{
	                ...
	                if (self.award_type == 10) {
	                    for (var i = 0; i < ret.data.listMap.length; i++) {
	                        if (ret.data.listMap[i].award_type == 10) {
	                            self.dataArr.push(ret.data.listMap[i]);
	                        }
	                    }
	                } else if (self.award_type == 20) {
	                    for (var i = 0; i < ret.data.listMap.length; i++) {
	                        if (ret.data.listMap[i].award_type == 20) {
	                            self.dataArr.push(ret.data.listMap[i]);
	                        }
	                    }
	                }
