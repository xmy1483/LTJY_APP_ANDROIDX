...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/0e323c8c9a1abbc6cc873d7a7d64b991', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/0e323c8c9a1abbc6cc873d7a7d64b991',undefined,undefined)
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            ...
	                            "autofocus": "false",
	                            "value": function () {return this.aliCount}
	                          },
	                          "events": {
	                            "input": "getAliCount"
	                          }
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            ...
	                            "placeholder": "¥ 请输入提现金额",
	                            "autofocus": "false",
	                            "value": function () {return this.inputMoney}
	                          },
	                          "events": {
	                            "input": "getMoney"
	                          }
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return '本次可提现' + (this.cash_balance) + '元'}
	                          }
	                        },
	                        {
	                          "type": "text",
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        wallentQuestion: function wallentQuestion() {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'wallet/wallentQuestion.js',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        getMoneyRecord: function getMoneyRecord() {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'wallet/getMoneyRecord.js',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        ...
	        getAliCount: function getAliCount(event) {
	            this.aliCount = event.value;
	            storage.setItem('aliCount', this.aliCount, function (e) {});
	        },
	        getMoney: function getMoney(event) {
	            this.inputMoney = event.value;
	        },
	        getAllMoney: function getAllMoney() {
	            this.inputMoney = this.cash_balance;
	        },
	        sureGetMoney: function sureGetMoney() {
	            if (parseInt(this.inputMoney) > parseInt(this.cash_balance)) {
	                this.confirm("可提现余额不足");
	                return;
	            }
	            if (this.aliCount.length == 0) {
	                this.confirm("请输入支付宝账号");
	                return;
	            }
	            if (this.inputMoney.length == 0) {
	                this.confirm("请输入提现金额");
	                return;
	            }
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "CASH_MONEY",
	                "actionType": 0,
	                "listMap": [{
	                    "customers_id": self.userInfo.customers_id,
	                    "login_phone": self.userInfo.currentPhone,
	                    "account": self.aliCount,
	                    "cash_type": 1,
	                    "cash_money": self.inputMoney,
	                    "content": "提现到支付宝"
	                }]
	            }, function (ret) {
	                if (ret.data.errorId == 0) {
	                    self.confirm("提现成功,如有问题请联系客服");
	                } else {
	                    self.confirm("提现失败,如有问题请联系客服");
	                }
	            });
	        },
	    ...
	    created: function created() {
	        ...
	        storage.getItem('aliCount', function (e) {
	        ...
	        self.cash_balance = decodeURIComponent(this._getUrlParam(url, 'cash_balance'));
