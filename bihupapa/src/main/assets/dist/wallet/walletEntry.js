...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/0095ccc991c22f412b92ffe03c3d7cab', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/0095ccc991c22f412b92ffe03c3d7cab',undefined,undefined)
	    ...
	    methods: {
	        baseConfig: function baseConfig() {
	            ...
	            this.$on('naviBar.rightItem.click', function (e) {
	                ...
	                var params = {
	                    'url': vm.baseURL + 'me/historyRepresent.js',
	                    'animated': 'true'
	                };
	        ...
	        shiwu: function shiwu() {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'ticket/myTicket.js?award_type=20',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        xianjin: function xianjin() {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'wallet/wallet.js',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        electron: function electron() {
	            ...
	            var params = {
	                'url': vm.baseURL + 'ticket/myTicket.js?award_type=10',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        }
