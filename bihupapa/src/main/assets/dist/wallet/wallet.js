...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/dd69a9f5a7df9d97eabccaaa97601156', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/dd69a9f5a7df9d97eabccaaa97601156',undefined,undefined)
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return '¥' + (this.cash_balance)}
	                      }
	                    }
	                  ]
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        getCountMoney: function getCountMoney() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "GET_CASH_XML.QUERY_ACCOUNT_BALANCE",
	                "actionType": 0,
	                "listMap": [{
	                ...
	                if (ret.data.listMap.length > 0) {
	                    self.cash_balance = ret.data.listMap[0].cash_balance;
	                }
	            });
	        },
	        ali: function ali() {
	            ...
	            var params = {
	                'url': vm.baseURL + 'wallet/aliWallet.js?cash_balance=' + vm.cash_balance,
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        kaiyoubao: function kaiyoubao() {
	            var vm = this;

	            var params = {
	                'url': vm.baseURL + 'wallet/kaiyoubaoWallet.js?cash_balance=' + vm.cash_balance,
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        cellClick: function cellClick(i) {
	            var vm = this;
	            if (i == 0) {
	                var params = {
	                    'url': vm.baseURL + 'ticket/myTicket.js',
	                    'animated': 'true'
	                };
	                vm.$call('navigator', 'push', params, function () {});
	            }
	            if (i == 1) {
	                ...
	                modal.callNative({ "nativeName": "kaiyoubao" }, function (ret) {});
	            }
	        }
	    },
	    ready: function ready() {
