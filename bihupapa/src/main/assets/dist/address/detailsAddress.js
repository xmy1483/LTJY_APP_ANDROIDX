...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/756df1dbe1576b71ed3ec1c46969d4f9', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/756df1dbe1576b71ed3ec1c46969d4f9',undefined,undefined)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    }, (0, _defineProperty3.default)(_methods, '_getUrlParam', function _getUrlParam(url, key) {
	        var reg = new RegExp('[?|&]' + key + '=([^&]+)');
	        var match = url.match(reg);
	        return match && match[1];
	    }), (0, _defineProperty3.default)(_methods, 'toAddressList', function toAddressList() {
	    ...
	    created: function created() {
	        ...
	        storage.getItem('addressName', function (e) {
	            var result = e.result;
	            if (result === 'success') {
	                var data = e.data;
	                self.name = data;
	        ...
	        storage.getItem('addressPhone', function (e) {
	            var result = e.result;
	            if (result === 'success') {
	                var data = e.data;
	                self.phone = data;
