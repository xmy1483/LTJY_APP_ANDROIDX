...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/a9ad0e23eaf2b4de3077dc37368f0dd3', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/a9ad0e23eaf2b4de3077dc37368f0dd3',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.addressList},
	            "value": "item"
	          },
	          "attr": {
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.item.recipient_name}
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.item.recipient_phone}
	                      }
	                    }
	                  ]
	                },
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "events": {
	                        "click": function ($event) {this.toSelect(this.$index,$event)}
	                      },
	                      "children": [
	                        {
	                          "type": "image",
	                          "shown": function () {return this.isSelectArr[this.$index]},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'iconImage/iconclick@2x.png'}
	                          },
	                          "style": {
	                            "height": "25wx",
	                            "width": "25wx"
	                        ...
	                        },
	                        {
	                          ...
	                          "shown": function () {return !this.isSelectArr[this.$index]},
	                          "attr": {
	                            "src": function () {return (this.imageURL) + 'iconImage/iconunclick@2x.png'}
	                          },
	                          "style": {
	                            "height": "25wx",
	                            "width": "25wx"
	                      ...
	                      "children": [
	                        {
	                          ...
	                          "events": {
	                            "click": function ($event) {this.toEditOneAddress(this.$index,$event)}
	                          },
	                          "children": [
	                            {
	                              "type": "image",
	                              "attr": {
	                                "src": "http://app5.bac365.com:10080/web_image/iconImage/edit.png"
	                              },
	                              "style": {
	                                "height": "20wx",
	                                "width": "25wx"
	                        ...
	                        },
	                        {
	                          ...
	                          "events": {
	                            "click": function ($event) {this.deleteAddress(this.$index,$event)}
	                          },
	                          "children": [
	                            {
	                              "type": "image",
	                              "attr": {
	                                "src": "http://app5.bac365.com:10080/web_image/iconImage/delete1.png"
	                              },
	                              "style": {
	                                "height": "23wx",
	                                "width": "20wx"
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.addressList.length==0},
	          "children": [
	            {
	              "type": "div",
	              "style": {
	              ...
	              "children": [
	                {
	                  "type": "image",
	                  "attr": {
	                    "src": "http://app5.bac365.com:10080/web_image/iconImage/reload.png"
	                  },
	                  "style": {
	                    "height": "60wx",
	                    "width": "60wx"
	          ...
	          "children": [
	            {
	              ...
	              "attr": {
	                "value": function () {return this.isEdit?'添加':'确定'}
	              }
	            }
	          ]
	        },
	    ...
	    methods: {
	        ...
	        confirm: function confirm(msg, okTitle, cancelTitle) {
	            ...
	            modal.confirm({
	                ...
	                if (msg === "确认删除邮寄地址") {
	                    self.sureDeleteAddress(self.deleteNum);
	                }
	            });
	        },
	        ...
	        toEditOneAddress: function toEditOneAddress(e) {
	            var self = this;

	            var params = {
	                'url': self.baseURL + 'address/inputAddress.js?from=addressList&address_id=' + self.addressList[e].address_id,
	                'animated': 'true'
	            };
	        ...
	        addAddress: function addAddress() {
	            var self = this;
	            var params = {
	                'url': self.baseURL + 'address/inputAddress.js?add=add',
	                'animated': 'true'
	            };
	            self.$call('navigator', 'push', params, function () {});
	        },
	        btnAction: function btnAction() {
	            ...
	            if (self.isEdit) {
	                ...
	                var params = {
	                    'url': self.baseURL + 'address/inputAddress.js?from=addressList',
	                    'animated': 'true'
	                };
	                self.$call('navigator', 'push', params, function () {});
	            } else {
	                ...
	                if (self.comeFrom === "me") {
	                    ...
	                    modal.httpServer({ "methodName": "APPLY_ACTIVITY",
	                        ...
	                        "listMap": [{
	                            ...
	                            "address_id": self.addressList[self.selectNum].address_id
	        ...
	        toSelect: function toSelect(e) {
	            var vm = this;
	            vm.selectNum = e;
	            var cc = vm.isSelectArr[e];
	            for (var i = 0; i < vm.isSelectArr.length; i++) {
	                vm.isSelectArr[i] = false;
	            }
	        ...
	        refreshData: function refreshData() {
	            ...
	            var arr = [];
	            for (var i = 0; i < vm.isSelectArr.length; i++) {
	                arr[arr.length] = vm.isSelectArr[i];
	            }
	            vm.isSelectArr = arr;
	        },
	        deleteAddress: function deleteAddress(i) {

	            this.deleteNum = i;
	            this.confirm("确认删除邮寄地址");
	        },
	        sureDeleteAddress: function sureDeleteAddress(i) {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.DELETE_MAILING_ADDRESS",
	                "actionType": 0,
	                "listMap": [{
	                    "address_id": self.addressList[i].address_id,
	                    "login_phone": self.userInfo.currentPhone
	                }]
	            }, function (ret) {
	                if (ret.data.errorId == 0) {
	        ...
	        getAddressList: function getAddressList() {
	            ...
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_MAILING_ADDRESS",
	                ...
	                if (ret.data.errorId == 0) {
	                    self.addressList = ret.data.listMap;
	                    self.isSelectArr = [];
	                    for (var i = 0; i < self.addressList.length; i++) {
	                        if (i == 0) {
	                            self.isSelectArr.push(true);
	                            self.selectNum = 0;
	                        } else {
	                            self.isSelectArr.push(false);
	                        }
	                    }
