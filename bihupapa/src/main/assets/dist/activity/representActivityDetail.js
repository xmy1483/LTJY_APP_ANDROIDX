...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/c5fd81832e2fbd092545f5270a5971ab', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/c5fd81832e2fbd092545f5270a5971ab',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	              ...
	              "children": [
	                {
	                  ...
	                  "attr": {
	                    "resize": "contain",
	                    "src": function () {return this.activityDetailInfo.adv_image?this.activityDetailInfo.adv_image:'https://app5.bac365.com:10443/web_image/representDetail/activityDetail.jpg'}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.activityDetailInfo.adv_title},
	          "children": [
	            {
	              "type": "div",
	              "style": {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.activityDetailInfo.adv_title}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.activityDetailInfo.start_time&&this.activityDetailInfo.end_time},
	          "children": [
	            {
	              "type": "div",
	              "style": {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.toTime(this.activityDetailInfo.start_time)+'- '+this.toTime(this.activityDetailInfo.end_time)}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.activityDetailInfo.award_remark},
	          "children": [
	            {
	              "type": "div",
	              "style": {
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "attr": {
	                    "value": function () {return this.activityDetailInfo.award_remark}
	                  }
	                }
	              ]
	            }
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.activityDetailInfo.adv_remark_url||this.activityDetailInfo.adv_remark},
	          "events": {
	            "click": "otherRequest"
	          },
	          "children": [
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "attr": {
	                        "value": function () {return this.activityDetailInfo.adv_remark}
	                      }
	                    },
	                    {
	                      "type": "image",
	                      ...
	                      "attr": {
	                        "src": "https://app5.bac365.com:10443/web_image/main/right_arrow.png"
	                      }
	                    }
	                  ]
	                }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        applyRepresent: function applyRepresent() {
	            var vm = this;
	        ...
	        judgeHasAuth: function judgeHasAuth() {
	            ...
	            modal.httpServer({ "methodName": "QUERY_APPLY_QUALIFIED",
	                ...
	                if (ret.data.errorId == 0) {
	                    self.searchUserCarInfo();
	                }
	            });
	        },
	        searchUserCarInfo: function searchUserCarInfo() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	        ...
	        searchAddress: function searchAddress() {
	            var vm = this;
	            var params = {
	                'url': vm.baseURL + 'address/inputAddress.js',
	                'animated': 'true'
	            };
	        ...
	        confirm: function confirm(msg, okTitle, cancelTitle) {
	            ...
	            modal.confirm({
	                ...
	                if (result === "确定") {
	                    var params = {
	                        'url': self.baseURL + 'myCar/myCar.js',
	                        'animated': 'true'
	                    };
	                    self.$call('navigator', 'push', params, function () {});
	                }
	        ...
	        confirmOther: function confirmOther(msg, okTitle, cancelTitle) {
	            var self = this;
	            if (!msg || typeof msg !== 'string') {
	                msg = "I am Confirm!";
	            }
	        ...
	        otherRequest: function otherRequest() {

	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            if (self.activityDetailInfo.adv_remark_url) {
	                modal.toWebView(self.activityDetailInfo.adv_remark_url);
	                return;
	            }
	            if (self.activityDetailInfo.adv_remark) {
	                self.confirmOther(self.activityDetailInfo.adv_remark);
	            }
	        },
	        cellClick: function cellClick(e) {
	            var vm = this;
	            var params = {
	                'url': vm.baseURL + 'myCar/myCar.js',
	                'animated': 'true'
	            };
	            vm.$call('navigator', 'push', params, function () {});
	        },
	        getData: function getData() {
	            var self = this;
	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_ACTIVITY",
	                "actionType": 0,
	                "listMap": [{
	                    "customers_id": self.userInfo.customers_id,
	                    "login_phone": self.userInfo.currentPhone,
	                ...
	                self.activityDetailInfo = ret.data.listMap[0];
	            });
	        },
	    ...
	    created: function created() {
	        ...
	        self.adv_activity_id = decodeURIComponent(this._getUrlParam(url, 'adv_activity_id'));
	        storage.setItem('adv_activity_id', self.adv_activity_id, function (e) {});
