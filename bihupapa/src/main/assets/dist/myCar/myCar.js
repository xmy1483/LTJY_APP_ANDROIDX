...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/842fa8b5d2f498c65f0f8b7e525be669', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/842fa8b5d2f498c65f0f8b7e525be669',undefined,undefined)
...
/***/ (function(module, exports) {
	...
	module.exports = {
	  ...
	  "children": [
	              ...
	              "children": [
	                ...
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    {
	                      "type": "input",
	                      "shown": function () {return !this.carInfo.car_id},
	                      "classList": [
	                        "cInput"
	                      ],
	                      "attr": {
	                        "type": "text",
	                        "placeholder": "请您输入车辆牌照",
	                        "autofocus": "false",
	                        "value": function () {return this.License}
	                      },
	                      "events": {
	                        "input": "onchangeLicense"
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.carInfo.car_license_no}
	                      }
	                    }
	                  ]
	                },
	                {
	                  ...
	                  "children": [
	                    ...
	                    },
	                    {
	                      ...
	                      "attr": {
	                        "type": "text",
	                        "placeholder": "请您输入车主姓名",
	                        "autofocus": "false",
	                        "value": function () {return this.userName}
	                      },
	                      "events": {
	                        "input": "onchangeUseName"
	                      }
	                    },
	                    {
	                      "type": "text",
	                      ...
	                      "attr": {
	                        "value": function () {return this.carInfo.car_name}
	                      }
	                    }
	                  ]
	                }
	                          ...
	                          "children": [
	                            {
	                              ...
	                              "attr": {
	                                "src": function () {return this.carImageUrl?this.carImageUrl:'https://app5.bac365.com:10443/web_image/iconImage/updateCar.png'}
	                              }
	                            }
	                          ]
	                        },
	    ...
	    {
	      "type": "div",
	      "shown": function () {return this.isShowBtn},
	      "style": {
	        "backgroundColor": "#E0E0E6"
	      },
	      "children": [
	    ...
	    {
	      "type": "div",
	      "shown": function () {return this.isShowSimple},
	      "classList": [
	        "simple"
	      ],
	      "style": {
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "src": "https://app5.bac365.com:10443/web_image/iconImage/Group20.png"
	          }
	        },
	        {
	          "type": "image",
	          ...
	          "attr": {
	            "src": "https://app5.bac365.com:10443/web_image/iconImage/unclick.png"
	          }
	        }
	      ]
	    }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        onchangeLicense: function onchangeLicense(event) {
	            this.License = event.value;
	            if (this.License.length >= 7) {
	                this.License = event.value.substr(0, 7).toUpperCase();
	            }
	            storage.setItem('License', this.License, function (e) {});
	        },
	        onchangeUseName: function onchangeUseName(event) {
	            this.userName = event.value;
	            storage.setItem('userName', this.userName, function (e) {});
	        },
	        lookSimple: function lookSimple() {
	            var vm = this;
	            vm.isShowSimple = !vm.isShowSimple;
	        },
	        toPhoto: function toPhoto() {
	            var self = this;
	            if (self.carInfo.car_id) {} else {
	                var modal = __weex_require__('@weex-module/httpModule');
	                modal.toTakePhotoView({}, function (ret) {
	                    self.UUID = JSON.parse(ret.data).UUID;
	                    self.carImageUrl = JSON.parse(ret.data).url;
	                });
	            }
	        },
	        ...
	        toAddress: function toAddress() {
	            ...
	            if (self.License.length == 0) {
	                self.confirm('请去填写车辆牌照');
	                return;
	            }
	            if (self.userName.length == 0) {
	                self.confirm('请去填写车主姓名');
	                return;
	            }
	            if (self.UUID.length == 0) {
	                self.confirm('请先去拍行驶证正面照');
	                return;
	            }

	            var modal = __weex_require__('@weex-module/httpModule');
	            modal.httpServer({ "methodName": "ACTIVITIE.SUBMIT_CAR_LICENSE",
	                "actionType": 0,
	                "listMap": [{
	                    "car_license_no": self.License,
	                    "customers_id": self.userInfo.customers_id,
	                    "login_phone": self.userInfo.currentPhone,
	                    "car_name": self.userName,
	                    "image_url": self.UUID }]
	            }, function (ret) {
	    ...
	    created: function created() {
	        ...
	        self.from = decodeURIComponent(this._getUrlParam(url, 'from'));
	        ...
	        storage.getItem('carInfo', function (e) {
	            ...
	            if (result === 'success') {
	                ...
	                self.carImageUrl = self.carInfo.driving_license_img_01;
	                if (self.from === "me" && self.carInfo.car_id) {

	                    self.isShowBtn = false;
	                }
	            } else {}
	        });
	        storage.getItem('License', function (e) {
	        ...
	        if (config.env.deviceWidth == 640) {
	            this.screenW = 750;
	            this.middleImageWidth = this.screenW - 20;
	        } else {
