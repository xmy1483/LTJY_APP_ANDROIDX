...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/af32ab4e783deee4bf35d5fd1c98ed7d', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/af32ab4e783deee4bf35d5fd1c98ed7d',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "append": "tree",
	          "repeat": {
	            "expression": function () {return this.activityList},
	            "value": "item"
	          },
	          "events": {
	                  ...
	                  "children": [
	                    {
	                      ...
	                      "children": [
	                        ...
	                        },
	                        {
	                          ...
	                          "attr": {
	                            "value": function () {return this.item.company_name}
	                          }
	                        }
	                      ]
	                    },
	                      ...
	                      "children": [
	                        {
	                          "type": "image",
	                          "attr": {
	                            "src": function () {return this.item.adv_image?this.item.adv_image:'https://app5.bac365.com:10443/web_image/message/messagemessage01@3x.png'},
	                            "resize": "contain"
	                          },
	                          "classList": [
	                            "content_img"
	        ...
	        },
	        {
	          "type": "cell",
	          "append": "tree",
	          "shown": function () {return this.activityList.length==0},
	          "children": [
	            {
	              "type": "div",
	              "style": {
	...
	module.exports = {
	    ...
	    methods: {
	        ...
	        cellClick: function cellClick(e) {
	            ...
	            vm.selectIndex = e;
	            var params = {
	                'url': vm.baseURL + 'activity/representActivityDetail.js?adv_activity_id=' + vm.activityList[vm.selectIndex].adv_activity_id,
	                'animated': 'true'
	            };
	        ...
	        getData: function getData() {
	            ...
	            modal.httpServer({ "methodName": "ACTIVITIE.QUERY_ACTIVITIES",
	                "actionType": 0,
	                "listMap": [{
	                    "customers_id": self.userInfo.customers_id,
	                    "login_phone": self.userInfo.currentPhone }]
	            }, function (ret) {
	                self.activityList = ret.data.listMap;
	            });
	        },
	        judgeHasAuth: function judgeHasAuth() {
	            ...
	            modal.httpServer({ "methodName": "QUERY_APPLY_QUALIFIED",
	                ...
	                if (ret.data.errorId == 0) {
	                    var params = {
	                        'url': self.baseURL + 'activity/representActivityDetail.js?adv_activity_id=' + self.activityList[self.selectIndex].adv_activity_id,
	                        'animated': 'true'
	                    };
