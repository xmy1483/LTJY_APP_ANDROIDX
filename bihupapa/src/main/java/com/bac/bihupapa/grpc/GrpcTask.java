...
public class GrpcTask extends AsyncTask<Void, Void, Method> {
    ...
    //private static String mHost = "gd.aja6.com";
    // private static String mHost = "192.168.0.107";
    //private static String mHost="121.43.172.16";
    //private static String mHost="gd.aja6.com";
    //private static String mHost="121.196.213.135";
    private static String mHost="app5.bac365.com";
//    private static String mHost="121.43.176.11";
    // private static String mHost = "192.168.1.200";
    ...
    private Method GET_KEY() {
        try {
            ...
            String json = Base64.encodeToString(
                    aes.encrypt(
                            JSON.toJSONString(mBean).getBytes(StandardCharsets.UTF_8)
                    ), 2
            );
            ...
            if (response.getERROR() == 0) {
                ...
                GrpcTask.aes = new AES(aesStr.getBytes());
                return null;
            } else {
                Method Bean = new Method();
