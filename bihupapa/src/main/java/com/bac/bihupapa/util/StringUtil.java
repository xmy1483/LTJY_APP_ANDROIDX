...
public class StringUtil {
    ...
    public static String decode2(Context context, String key) {
        String s = "";
        s = new String(Base64.decode(StringUtil.localDeCode(PreferenceManager.getDefaultSharedPreferences(context).getString(key, ""), (byte) Integer.parseInt(context.getString(R.string.seed_num) + Constants.XX + BuildConfig.appKeySeed)), 2), StandardCharsets.UTF_8);
        return s;
    }
