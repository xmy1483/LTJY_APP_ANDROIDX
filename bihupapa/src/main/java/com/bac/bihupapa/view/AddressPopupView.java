...
import com.bac.bihupapa.adapter.AddressAdapter1;
import com.bac.bihupapa.adapter.AddressAdapter2;
import com.bac.bihupapa.adapter.AddressAdapter3;
...
public class AddressPopupView {
    ...
    public AddressPopupView(AppCompatActivity activity, final HashMap mHashMap) {
        ...
        mRv01 = popup.findViewById(R.id.rv_01);
        mRv02 = popup.findViewById(R.id.rv_02);
        mRv03 = popup.findViewById(R.id.rv_03);
        ...
        mPopupWindow = new PopupWindow(popup, ViewGroup.LayoutParams.MATCH_PARENT, height / 3);
        // 设置获取焦点
