...
public class SGWeexModule extends WXModule {
    ...
    //页面跳转
        ...
        if ("SGCardPurshase".equals(url)){
            UIUtil.startActivityInAnim((AppCompatActivity) context, new Intent(context, WeexActivityForSGPage.class)
    ...
    public String getOrderId() {
        return PreferenceManager.getDefaultSharedPreferences(mWXSDKInstance.getContext()).getString("orderId","");
    }
...
// 请求地址方法内定义
    ...
    @JSMethod
    public void requestForAll(final Map<String, Object> map, final JSCallback jsCallback) {
//网络请求
// 请求地址方法内定义
        //
                ...
                .subscribe(new Action1<Object>() {
                    ...
                    public void call(Object o) {
                        try {
                            HashMap<String, Object> hashMap = new HashMap<>();
                            Map mapo = JSONObject.parseObject(o.toString(), Map.class);
                            hashMap.put("data", mapo);
                            jsCallback.invokeAndKeepAlive(hashMap);
                        }catch (Exception e){
                            List<Map<String,Object>> data = (List<Map<String, Object>>) o;
                            Map mapo = JSONObject.parseObject(data.get(0).get("JSON").toString(), Map.class);
                            jsCallback.invokeAndKeepAlive(mapo);
                        }
                ...
                .subscribe(new Action1<Object>() {
                    ...
                    public void call(Object o) {
                        ...
                        if (data.get(0).size() == 0){
                            ...
                            jsCallback.invokeAndKeepAlive(data.get(0).get("gift_card_pwd").toString());
                        }
                    }
                });
    }
                                    ...
                                    HttpHelperLib.getInstance()
                                            ...
                                            .subscribe(new Action1<Object>() {
                                                ...
                                                public void call(final Object o) {
                                                    try{
                                                        //Log.i("sss", JSONObject.toJSONString(o));
                                                        ...
                                                        if ((Boolean) ((Map<String, Object>) o).get("success")){
                                                            ...
                                                            bean.put("recharge_money", map.get("recharge_money"));
