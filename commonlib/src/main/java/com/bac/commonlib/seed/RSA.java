...
public class RSA {
    ...
    public static Map<String, String> generateKeyPair() throws Exception {
        ...
        String pub = new String(Base64.encode(publicKeyBytes, FLAG), CHAR_ENCODING);

        /** 得到私钥 */
        Key    privateKey      = kp.getPrivate();
        byte[] privateKeyBytes = privateKey.getEncoded();
        String pri             = new String(Base64.encode(privateKeyBytes, FLAG), CHAR_ENCODING);
        ...
        byte[]       deBase64Value = Base64.encode(b, FLAG);
    ...
    public static String encrypt(String source, String publicKey)
        ...
        return new String(Base64.encode(b1, FLAG),
                CHAR_ENCODING);
    }
    ...
    public static String decrypt(String cryptograph, String privateKey)
        ...
        byte[] b1 = Base64.decode(cryptograph, FLAG);
