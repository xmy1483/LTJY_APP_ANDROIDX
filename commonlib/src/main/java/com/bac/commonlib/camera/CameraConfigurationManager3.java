...
public class CameraConfigurationManager3 {

    private static final String TAG = CameraConfigurationManager3.class
            .getSimpleName();
    ...
    CameraConfigurationManager3(Context context) {
    ...
    void initFromCameraParameters(Camera camera) {
        ...
        mOptimalPreviewSize = getOptimalPreviewSize(parameters.getSupportedPreviewSizes(), screenResolution.x, screenResolution.y);
    ...
    void setDesiredCameraParameters(Camera camera) {
       ...
       /* parameters.setPreviewSize(cameraResolution.x, cameraResolution.y);
        ...
        parameters.setPictureSize(mOptimalPreviewSize.width, mOptimalPreviewSize.height);
        setFlash(parameters);
        setZoom(parameters);
    ...
    private void setFlash(Camera.Parameters parameters) {
        if (Build.MODEL.contains("Behold II") && CameraManager3.SDK_INT == 3) { // 3
