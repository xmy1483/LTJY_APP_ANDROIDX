...
public class CircleProgressbar extends TextView
{
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, R.styleable.cl_CircleProgressbar);
        if (typedArray.hasValue(R.styleable.cl_CircleProgressbar_cl_in_circle_color))
            inCircleColors = typedArray.getColorStateList(R.styleable.cl_CircleProgressbar_cl_in_circle_color);
        else
